  ...
  return (
    <div>
      ...
      <header id="home">
       ...
       /></p><br/>
            <button varient='contained'>Send Otp</button><br/>
    ...
    <section class="membership" id="membership">
      <div class="section__container membership__container">
        ...
        <h2 class="section__header">Choose your package</h2>
        <div class="membership__grid">
          <div class="membership__card">
            <h4>6 Months</h4>
            <h2><span class="WebRupee">&#x20B9;</span>5499</h2>
            <h3>For 1 Year</h3>
          ...
          <div class="membership__card">
            <h4>3 Months</h4>
            <h2><span class="WebRupee">&#x20B9;</span>200</h2>
            <h3>For 1 Month</h3>
            <h4>ENJOY ALL THE FEATURES</h4>
            <p>Group classes</p>
          ...
          <div class="membership__card">
            <h4>1 Month</h4>
            <h2><span class="WebRupee">&#x20B9;</span>85</h2>
            <h3>For 1 Week</h3>
            <h4>ENJOY ALL THE FEATURES</h4>
